...
workflow.add_node("retail_sentiment_agent", retail_sentiment_agent)
workflow.add_node("chief_strategist", strategist_agent)

# Define the edges
workflow.set_entry_point("fundamental_analyst")
workflow.add_edge("fundamental_analyst", "technical_analyst")
workflow.add_edge("technical_analyst", "oi_analyst")
workflow.add_edge("oi_analyst", "retail_sentiment_agent")
workflow.add_edge("retail_sentiment_agent", "chief_strategist")
